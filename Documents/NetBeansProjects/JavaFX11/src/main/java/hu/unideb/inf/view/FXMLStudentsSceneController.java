...
public class FXMLStudentsSceneController implements Initializable {
    ...
    void handleLoadButtonPushed() {
        ...
        name1Label.textProperty().bind(model.getStudent2().nameProperty());

        creditsLabel.setText("" + model.getStudent().getAttack());
        attack1Label.setText("" + model.getStudent2().getAttack());       
        
        bdLabel.setText(""+model.getStudent().getDefend());
        defend1Label.setText(""+model.getStudent2().getDefend());
    }
